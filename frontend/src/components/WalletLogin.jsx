...
const WalletLogin = ({ onWalletLoaded, onCreateNew }) => {
  const [formData, setFormData] = useState({
    username: localStorage.getItem('wepo_wallet_username') || '',
    password: ''
  });
          ...
          <div className="space-y-6">
            ...
            {mode === 'recover' && (
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Choose a new local encryption password. Your phrase and password never go to the server.</p>
              </div>
            )}
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-purple-200 mb-2">
                  {mode === 'recover' ? 'Device label (optional)' : 'Wallet label'}
                </label>
                <input
                  type="text"
                  name="username"
                  ...
                  placeholder={mode === 'recover' ? 'My WEPO wallet' : 'Enter your wallet label'}
              ...
              <div>
                <label className="block text-sm font-medium text-purple-200 mb-2">
                  {mode === 'recover' ? 'New local encryption password' : 'Password'}
                </label>
